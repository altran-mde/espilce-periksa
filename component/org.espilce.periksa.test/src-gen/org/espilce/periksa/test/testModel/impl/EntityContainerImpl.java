 ...
 * </p>
 * <ul>
 *   <li>{@link org.espilce.periksa.test.testModel.impl.EntityContainerImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityContainerImpl extends MinimalEObjectImpl.Container implements EntityContainer {
	/**
	...
	protected EClass eStaticClass() {
		return TestModelPackage.Literals.ENTITY_CONTAINER;
	}
	...
	public EList<Entity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<Entity>(Entity.class, this,
					TestModelPackage.ENTITY_CONTAINER__ENTITIES);
		}
		return entities;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case TestModelPackage.ENTITY_CONTAINER__ENTITIES:
