...
import org.espilce.periksa.preferences.IPreferenceValues;
...
public class PreferenceValuesByLanguage {
  ...
  private final Map<String, IPreferenceValues> preferencesByLanguage = new HashMap<String, IPreferenceValues>();
